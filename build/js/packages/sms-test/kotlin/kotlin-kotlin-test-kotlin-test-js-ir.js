(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof this['kotlin-kotlin-stdlib'] === 'undefined') {
      throw new Error("Error loading module 'kotlin-kotlin-test-kotlin-test-js-ir'. Its dependency 'kotlin-kotlin-stdlib' was not found. Please, check whether 'kotlin-kotlin-stdlib' is loaded prior to 'kotlin-kotlin-test-kotlin-test-js-ir'.");
    }
    root['kotlin-kotlin-test-kotlin-test-js-ir'] = factory(typeof this['kotlin-kotlin-test-kotlin-test-js-ir'] === 'undefined' ? {} : this['kotlin-kotlin-test-kotlin-test-js-ir'], this['kotlin-kotlin-stdlib']);
  }
  ...
  var Annotation = kotlin_kotlin.$_$.h2;
  var classMeta = kotlin_kotlin.$_$.k1;
  var AssertionError_init_$Create$ = kotlin_kotlin.$_$.i;
  var defineProp = kotlin_kotlin.$_$.l1;
  ...
  setMetadataFor(BareAdapter, 'BareAdapter', classMeta, VOID, VOID, BareAdapter);
  setMetadataFor(JasmineLikeAdapter, 'JasmineLikeAdapter', classMeta, VOID, VOID, JasmineLikeAdapter);
  setMetadataFor(QUnitAdapter, 'QUnitAdapter', classMeta, VOID, VOID, QUnitAdapter);
  //endregion
  ...
  function checkResultIsFailure(exceptionClass, message, blockResult) {
    ...
    if (exception == null) {
      ...
      get_asserter().fail_o3vfxl_k$(messagePrefix(message) + ('Expected an exception of ' + exceptionClass + ' to be thrown, but was completed successfully.'));
      tmp = tmp$ret$0;
    } else {
      var tmp$ret$1;
      // Inline function 'kotlin.test.checkResultIsFailure.<anonymous>' call
      ...
      get_asserter().fail_zdvzi9_k$(messagePrefix(message) + ('Expected an exception of ' + exceptionClass + ' to be thrown, but was ' + exception), exception);
      tmp = tmp$ret$1;
    }
  }
